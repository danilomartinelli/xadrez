   ...
   //colocando as barras da quina
    ...
    for (linha = 0; linha < 10; linha++){
        ...
        for(aux=0; aux<3; aux++){
            ...
            for (coluna = 0; coluna < 10; coluna++){
                // verificando se é os espaços internos da matrix
                if((linha <= 8 && linha >= 1) && (coluna <= 8 && coluna >= 1)){
                    // se o valor de aux for par, é para colocar os backgrounds
                    if(aux%2==0){
                            ...
                            // se o valor de coluna+linha for impar colocar o backgroud branco
                                ...
                                // colocando o background preto. como o fundo do DOS é preto, basta colocar espaços vazios
                                printf("     ");
                            }
                    }
                ...
                //se não forem os espaços internos e sim as coordenadas auxiliares
                else{
...
// função para mover o bispo minusculo
void validar_movimento_bispob (char tabuleiro[10][10], int linha, int coluna, int linhavelha, int colunavelha,int *movimento_valido){
    ...
    if (abs((coluna-colunavelha)) == abs((linha-linhavelha))){
         ...
         if (linhavelha<linha&&NaoEntraMais==0){
            ...
            if(colunavelha>coluna){
                // se ele se locomover uma posição
        ...
        if (linha<linhavelha&&NaoEntraMais==0){
            ...
            if(colunavelha>coluna){
                ...
                // se ele se locomover varias posiçoes
                else{
                    //função que verifica se no intervalo entre a posição original e a final tem alguma peca
