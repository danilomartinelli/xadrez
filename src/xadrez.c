...
void validar_movimento_bispoB (char tabuleiro[10][10], int linha, int coluna, int linhavelha, int colunavelha,int *movimento_valido);
//função do movimento do cavalo grande
...
//função do movimento do cavalo pequeno
void validar_movimento_cavaloC (char tabuleiro[10][10], int linha, int coluna, int linhavelha, int colunavelha,int *movimento_valido);
...
void validar_movimento_bispob(char tabuleiro[10][10], int linha, int coluna, int linhavelha, int colunavelha, int *movimento_valido){
    ...
    *movimento_valido=0;
    ...
    if (abs(colunavelha - coluna) == abs(linhavelha - linha))
    {
        ...
        if (coluna > colunavelha && linha > linhavelha && breakIf)
        {
            ...
            {
                //peca da posição em questão
                tempPiece = tabuleiro[auxRow][auxColumn];
                // se tiver uma letra no intervalo
                if (tempPiece != '-')
                {
                    // se essa letra for maiuscula
                    if (islower(tempPiece) == 0)
                    {
                        // o bispo não pode comer
                        *movimento_valido = 0;
                        // não entra nos outros laços
                        breakIf = 0;
                    }
                    else
                    {
                        // se na posição final tem uma peca minuscula
...
void validar_movimento_bispoB(char tabuleiro[10][10], int linha, int coluna, int linhavelha, int colunavelha, int *movimento_valido){
    ...
    *movimento_valido=0;
    ...
    if (abs(colunavelha - coluna) == abs(linhavelha - linha))
    {
        ...
        //Bispo percorrendo para o inferior direito.
        if ((coluna > colunavelha) && (linha > linhavelha) && (breakIf==1))
        {
            for (auxRow = (linhavelha + 1), auxColumn = (colunavelha + 1); auxRow <= linha, auxColumn <= coluna; auxRow++, auxColumn++)
            {
                tempPiece = tabuleiro[auxRow][auxColumn];
        ...
        //Bispo percorrendo para o inferior esquerdo.
        if ((linha > linhavelha) && (coluna < colunavelha) && (breakIf==1))
        {
            for (auxColumn = (colunavelha - 1), auxRow = (linhavelha + 1); auxColumn >= coluna, auxRow <= linha; auxRow++, auxColumn--)
            {
                tempPiece = tabuleiro[auxRow][auxColumn];
        ...
        //Bispo percorrendo para o superior esquerdo.
        if ((linha < linhavelha) && (coluna < colunavelha) && (breakIf==1))
        {
            for (auxColumn = (colunavelha - 1), auxRow = (linhavelha - 1); auxColumn >= coluna, auxRow >= linha; auxColumn--, auxRow--)
            {
...
// função para mover o cavalo minusculo
void validar_movimento_cavaloc (char tabuleiro[10][10], int linha, int coluna, int linhavelha, int colunavelha,int *movimento_valido){
    *movimento_valido=0;
                ...
                if(isalpha(tabuleiro[linha][coluna])!=0){
                    ...
                    if(isupper(tabuleiro[linha][coluna])!=0){
                        ...
                        *movimento_valido=1;
                            ...
                            // O cavalo não pode comer e andar
                            *movimento_valido=0;
                        }
                    }
...
// função para mover o cavalo maiusculo
void validar_movimento_cavaloC (char tabuleiro[10][10], int linha, int coluna, int linhavelha, int colunavelha,int *movimento_valido){
    *movimento_valido=0;
        if(((linhavelha-linha==2)&&(colunavelha-coluna==1)) || ((linhavelha-linha==1)&&(colunavelha-coluna==2)) || ((linha-linhavelha==1)&&(colunavelha-coluna==2)) || ((linha-linhavelha==2)&&(colunavelha-coluna==1)) || ((linhavelha-linha==2)&&(coluna-colunavelha==1)) || ((linhavelha-linha==1)&&(coluna-colunavelha==2)) || ((linha-linhavelha==1)&&(coluna-colunavelha==2)) || ((linha-linhavelha==2)&&(coluna-colunavelha==1))){
            // se no local de destino tiver uma peca
...
void validar_movimento_rainhar (char tabuleiro[10][10], int linha, int coluna, int linhavelha, int colunavelha,int *movimento_valido){
    ...
    validar_movimento_bispob(tabuleiro, linha, coluna, linhavelha, colunavelha, movimento_valido);
    // se o movimento da rainha não corresponder com o movimento do bispo
    if(*movimento_valido==0){
